...
namespace CirculoDeCredito\DigitalCheck\Client\Interceptor;
...
use CirculoDeCredito\DigitalCheck\Client\Interceptor\MyLogger;
use CirculoDeCredito\DigitalCheck\Client\Model\Errors;
use CirculoDeCredito\DigitalCheck\Client\Model\Error;

class MiddlewareEvents
{
    
    function __construct(CirculoDeCredito\DigitalCheck\Client\Interceptor\KeyHandler $signer)
    {
        $this->signer = $signer;
...
function build_error($code, $message){
    $error = new CirculoDeCredito\DigitalCheck\Client\Model\Error([
        "code" => $code,
        "message" => $message
    ]);
    $errors = new CirculoDeCredito\DigitalCheck\Client\Model\Errores(["errors" => [$error]]);
